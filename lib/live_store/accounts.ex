defmodule LiveStore.Accounts do
  @moduledoc """
  ...
  See `LiveStore.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  ## Examples
      ...
      iex> deliver_user_update_email_instructions(user, current_email, &url(~p"/account/settings/confirm-email/#{&1}"))
      {:ok, %{to: ..., body: ...}}
