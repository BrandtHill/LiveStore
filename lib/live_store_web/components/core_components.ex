defmodule LiveStoreWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-base-300/10 ring-base-300/10 relative hidden rounded-2xl bg-base-100 p-14 shadow-lg ring-1 transition"
            >
  ...
  def header(assigns) do
    ~H"""
    <header class={[@actions != [] && "md:flex items-center justify-between gap-6", "pb-4"]}>
      <div>
  ...
  def back(assigns) do
    ...
    <div class="mt-16">
      <.link
        navigate={@navigate}
        class="text-sm font-semibold leading-6 text-base-content hover:text-base-content"
      >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveStoreWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveStoreWeb.Gettext, "errors", msg, opts)
    end
  end
