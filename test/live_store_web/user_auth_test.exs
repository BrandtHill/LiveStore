defmodule LiveStoreWeb.UserAuthTest do
  use LiveStoreWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias LiveStore.Accounts
  alias LiveStoreWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LiveStoreWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LiveStoreWeb.Endpoint.subscribe(live_socket_id)
